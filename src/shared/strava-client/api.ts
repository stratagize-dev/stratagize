...
export const ActivitiesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, options: any = {}): FetchArgs {
...
export const ActivitiesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DetailedActivity> {
...
export const ActivitiesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, options?: any) {
...
export class ActivitiesApi extends BaseAPI {
     ...
     */
    public createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, options?: any) {
...
export const SegmentsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        exploreSegments(bounds: Array<number>, activityType?: 'running' | 'riding', minCat?: number, maxCat?: number, options: any = {}): FetchArgs {
...
export const SegmentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        exploreSegments(bounds: Array<number>, activityType?: 'running' | 'riding', minCat?: number, maxCat?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExplorerResponse> {
...
export const SegmentsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        exploreSegments(bounds: Array<number>, activityType?: 'running' | 'riding', minCat?: number, maxCat?: number, options?: any) {
...
export const StreamsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getActivityStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         * @throws {RequiredError}
         */
        getSegmentEffortStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         * @throws {RequiredError}
         */
        getSegmentStreams(id: number, keys: Array<'distance' | 'latlng' | 'altitude'>, keyByType: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
...
export const StreamsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getActivityStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<StreamSet> {
         ...
         * @throws {RequiredError}
         */
        getSegmentEffortStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<StreamSet> {
         ...
         * @throws {RequiredError}
         */
        getSegmentStreams(id: number, keys: Array<'distance' | 'latlng' | 'altitude'>, keyByType: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<StreamSet> {
...
export const StreamsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getActivityStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options?: any) {
         ...
         * @throws {RequiredError}
         */
        getSegmentEffortStreams(id: number, keys: Array<'time' | 'distance' | 'latlng' | 'altitude' | 'velocity_smooth' | 'heartrate' | 'cadence' | 'watts' | 'temp' | 'moving' | 'grade_smooth'>, keyByType: boolean, options?: any) {
         ...
         * @throws {RequiredError}
         */
        getSegmentStreams(id: number, keys: Array<'distance' | 'latlng' | 'altitude'>, keyByType: boolean, options?: any) {
...
export const UploadsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUpload(file?: any, name?: string, description?: string, trainer?: string, commute?: string, dataType?: 'fit' | 'fit.gz' | 'tcx' | 'tcx.gz' | 'gpx' | 'gpx.gz', externalId?: string, options: any = {}): FetchArgs {
...
export const UploadsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUpload(file?: any, name?: string, description?: string, trainer?: string, commute?: string, dataType?: 'fit' | 'fit.gz' | 'tcx' | 'tcx.gz' | 'gpx' | 'gpx.gz', externalId?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Upload> {
...
export const UploadsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUpload(file?: any, name?: string, description?: string, trainer?: string, commute?: string, dataType?: 'fit' | 'fit.gz' | 'tcx' | 'tcx.gz' | 'gpx' | 'gpx.gz', externalId?: string, options?: any) {
...
export class UploadsApi extends BaseAPI {
     ...
     * @memberof UploadsApi
     */
    public createUpload(file?: any, name?: string, description?: string, trainer?: string, commute?: string, dataType?: 'fit' | 'fit.gz' | 'tcx' | 'tcx.gz' | 'gpx' | 'gpx.gz', externalId?: string, options?: any) {
